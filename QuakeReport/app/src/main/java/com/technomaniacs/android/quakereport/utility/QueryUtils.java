package com.technomaniacs.android.quakereport.utility;
...
public final class QueryUtils {
       ...
       /** USGC query request **/
       private static final String USGS_REQUEST="https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2021-01-01&endtime=2021-10-02&limit=20";
        ...
        public static boolean isEmpty(String jsonResponse)
        {
            return (jsonResponse==null||jsonResponse.length()==0)?true:false;
        }
        ...
        public static ArrayList<Earthquake> extractEarthquakes(String response) {
            ...
            try {
                ...
                JSONArray earthquakesJSONArray=root.optJSONArray("features");
                if(earthquakesJSONArray!=null)
                {
                    for(int i=0;i<earthquakesJSONArray.length();i++)
                    {       JSONObject obj=earthquakesJSONArray.getJSONObject(i);
                            JSONObject properties=obj.getJSONObject("properties");
                            earthquakes.add(new Earthquake((float)properties.getDouble("mag"),
        ...
        public static String fetchData(String usgsurl)
        {
...
/* create connection and reterieve data*/
    public static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            {
                Log.d("QueryUtils:",urlConnection.getResponseCode()+" ");
            }
        } catch (IOException e) {
